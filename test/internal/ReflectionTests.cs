...
*/
        [Test]
        public void Reflection_IsCdrcsed()
        {
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(Cdrcsed<>)));
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(Cdrcsed<BasicTypes>)));
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(CdrcsedVoid<>)));
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(CdrcsedVoid<DdsCdrReader<InputBuffer>>)));
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(CustomCdrcsed<>)));
            Assert.IsTrue(Reflection.IsCdrcsed(typeof(CustomCdrcsed<BasicTypes>)));

            Assert.IsFalse(Reflection.IsCdrcsed(typeof(int)));
            Assert.IsFalse(Reflection.IsCdrcsed(typeof(BasicTypes)));
        }
        ...
        class CustomCdrcsed<T> : ICdrcsed
        {
            readonly ICdrcsed<T> _instance;

            public CustomCdrcsed(ICdrcsed<T> instance)
            {
                _instance = instance;
            }
