namespace UnitTest
{
    ...
    public class DeserializerControlsTests
    {
        ...
        static T DeserializeBadDataHelper<T, U>(CreationDelegate<U> creator) where U : Cdrcs.IO.IInputStream, Cdrcs.IO.ICloneable<U>
        {
        ...
        void DeserializeBadDataTestImpl(ConstraintDelegate constraint)
        {
            ...
            Assert.Throws(constraint(), () => DeserializeBadDataHelper<StructWithCdrcsed, InputBuffer>(InputBufferCreator));
            ...
            Assert.Throws(constraint(), () => DeserializeBadDataHelper<StructWithCdrcsed, InputStream>(InputStreamCreator));
