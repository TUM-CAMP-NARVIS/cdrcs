namespace UnitTest
{
    ...
    public class UnsafeInputBufferTests : IInputStreamTestsBase<Cdrcs.IO.Unsafe.InputBuffer>
    {
        protected override Cdrcs.IO.Unsafe.InputBuffer MakeInputStream(ArraySegment<byte> buffer)
        {
            return new Cdrcs.IO.Unsafe.InputBuffer(buffer);
        }
    }

    public class UnsafeInputBufferOffsetTests : IInputStreamTestsBase<Cdrcs.IO.Unsafe.InputBuffer>
    {
        protected override Cdrcs.IO.Unsafe.InputBuffer MakeInputStream(ArraySegment<byte> buffer)
        {
            return new Cdrcs.IO.Unsafe.InputBuffer(EmbedBuffer(buffer));
        }
    }

    public class SafeInputBufferTests : IInputStreamTestsBase<Cdrcs.IO.Safe.InputBuffer>
    {
        protected override Cdrcs.IO.Safe.InputBuffer MakeInputStream(ArraySegment<byte> buffer)
        {
            return new Cdrcs.IO.Safe.InputBuffer(buffer);
        }
    }

    public class SafeInputBufferOffsetTests : IInputStreamTestsBase<Cdrcs.IO.Safe.InputBuffer>
    {
        protected override Cdrcs.IO.Safe.InputBuffer MakeInputStream(ArraySegment<byte> buffer)
        {
            return new Cdrcs.IO.Safe.InputBuffer(EmbedBuffer(buffer));
        }
    }
