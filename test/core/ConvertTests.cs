namespace UnitTest.Convert
{
    ...
    public class Dates
    {
        [global::Cdrcs.Id(0), global::Cdrcs.Type(typeof(long))]
        public System.DateTime _date { get; set; }

        [global::Cdrcs.Id(1), global::Cdrcs.Type(typeof(List<long>))]
        public List<System.DateTime> _dateVector { get; set; }

        [global::Cdrcs.Id(2), global::Cdrcs.Type(typeof(LinkedList<long>))]
        public LinkedList<System.DateTime> _dateList { get; set; }

        [global::Cdrcs.Id(3), global::Cdrcs.Type(typeof(Dictionary<int,long>))]
        public Dictionary<int, System.DateTime> _dateMap { get; set; }

        [global::Cdrcs.Id(4), global::Cdrcs.Type(typeof(global::Cdrcs.Tag.nullable<long>))]
        public System.DateTime? _dateNullable { get; set; }

        [global::Cdrcs.Id(5), global::Cdrcs.Type(typeof(long)), global::Cdrcs.Required]
        public System.DateTime _dateRequired { get; set; }

        [global::Cdrcs.Id(6), global::Cdrcs.Type(typeof(long)), global::Cdrcs.RequiredOptional]
    ...
    {
        [global::Cdrcs.Id(0), global::Cdrcs.Type(typeof(global::Cdrcs.Tag.blob))]
        public decimal _dec { get; set; }

        [global::Cdrcs.Id(1), global::Cdrcs.Type(typeof(List<global::Cdrcs.Tag.blob>))]
        public List<decimal> _decVector { get; set; }

        [global::Cdrcs.Id(2), global::Cdrcs.Type(typeof(LinkedList<global::Cdrcs.Tag.blob>))]
        public LinkedList<decimal> _decList { get; set; }

        [global::Cdrcs.Id(3), global::Cdrcs.Type(typeof(Dictionary<int, global::Cdrcs.Tag.blob>))]
        public Dictionary<int, decimal> _decMap { get; set; }

        [global::Cdrcs.Id(4), global::Cdrcs.Type(typeof(global::Cdrcs.Tag.nullable<global::Cdrcs.Tag.blob>))]
        public decimal? _decNullable { get; set; }

        [global::Cdrcs.Id(5), global::Cdrcs.Type(typeof(global::Cdrcs.Tag.blob)), global::Cdrcs.Required]
        public decimal _decRequired { get; set; }

        [global::Cdrcs.Id(6), global::Cdrcs.Type(typeof(global::Cdrcs.Tag.blob)), global::Cdrcs.RequiredOptional]
    ...
    public class ConvertTests
    {
        ...
        public void Setup()
        {
            CdrcsTypeAliasConverter.ResetCounts();
        }
        ...
        public void CorrectSerializeConvertCountLongStruct()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromDateTimeCount);
            Assert.AreEqual(0, CdrcsTypeAliasConverter.ConvertToDateTimeCount);
        }
        ...
        public void CorrectRoundtripConvertCountLongStruct()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromDateTimeCount);
            Assert.AreEqual(foo2.CountInstances(), CdrcsTypeAliasConverter.ConvertToDateTimeCount);
            Assert.AreEqual(foo.CountInstances(), foo2.CountInstances());
            Assert.IsTrue(Cdrcs.Comparer.Equal(foo, foo2));
        }
        ...
        public void CorrectSerializeConvertCountBlobStruct()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromDecimalCount);
            Assert.AreEqual(0, CdrcsTypeAliasConverter.ConvertToDecimalCount);
        }
        ...
        public void CorrectRoundtripConvertCountBlobStruct()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromDecimalCount);
            Assert.AreEqual(foo2.CountInstances(), CdrcsTypeAliasConverter.ConvertToDecimalCount);
            Assert.AreEqual(foo.CountInstances(), foo2.CountInstances());
            Assert.IsTrue(Cdrcs.Comparer.Equal(foo, foo2));
        }
        ...
        public void CorrectSerializeConvertCountRef()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromRefObjectCount);
            Assert.AreEqual(0, CdrcsTypeAliasConverter.ConvertToRefObjectCount);
        }
        ...
        public void CorrectRoundtripConvertCountRef()
        {
            ...
            Assert.AreEqual(foo.CountInstances(), CdrcsTypeAliasConverter.ConvertFromRefObjectCount);
            Assert.AreEqual(foo2.CountInstances(), CdrcsTypeAliasConverter.ConvertToRefObjectCount);
            Assert.AreEqual(foo.CountInstances(), foo2.CountInstances());
            Assert.IsTrue(Cdrcs.Comparer.Equal(foo, foo2));
        }
