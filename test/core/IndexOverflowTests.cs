...
namespace UnitTest
{
    ...
    class IndexOverflowTests
    {
        ...
        public void CompactBinaryReader_Skip_String_NegativeLength_Throws()
        {
            ...
            var reader = new CompactBinaryReader<InputBuffer>(input);
            Assert.Throws<OverflowException>(() => Deserialize<CdrcsedAlias>.From(reader));
        }
        ...
        public void CompactBinaryReader_SkipContainer_Float_OverflowLength_Throws()
        {
            ...
            var input = new InputBuffer(data);
            var reader = new CompactBinaryReader<InputBuffer>(input);
            Assert.Throws<OverflowException>(() => Deserialize<CdrcsClass<List<double>>>.From(reader));
        }
        ...
        public static IEnumerable<byte[]> FastBinaryOverflowingLengthPayloads()
        {
            ...
            byte[][] testCases =
            {
                new byte[]{(int)CdrcsDataType.BT_UINT16, 0x80, 0x80, 0x80, 0x80, 0x04}, // Bytes: int.MaxValue / sizeof(Uint16) + 1
                new byte[]{(int)CdrcsDataType.BT_UINT32, 0x80, 0x80, 0x80, 0x80, 0x02}, // Bytes: int.MaxValue / sizeof(Uint32) + 1
                new byte[]{(int)CdrcsDataType.BT_UINT64, 0x80, 0x80, 0x80, 0x80, 0x01}, // Bytes: int.MaxValue / sizeof(Uint64) + 1
                new byte[]{(int)CdrcsDataType.BT_FLOAT, 0x80, 0x80, 0x80, 0x80, 0x02}, // Bytes: int.MaxValue / sizeof(float) + 1
                new byte[]{(int)CdrcsDataType.BT_DOUBLE, 0x80, 0x80, 0x80, 0x80, 0x01}, // Bytes: int.MaxValue / sizeof(double) + 1
                new byte[]{(int)CdrcsDataType.BT_INT16, 0x80, 0x80, 0x80, 0x80, 0x04}, // Bytes: int.MaxValue / sizeof(Int16) + 1
                new byte[]{(int)CdrcsDataType.BT_INT32, 0x80, 0x80, 0x80, 0x80, 0x02}, // Bytes: int.MaxValue / sizeof(Int32) + 1
                new byte[]{(int)CdrcsDataType.BT_INT64, 0x80, 0x80, 0x80, 0x80, 0x01}, // Bytes: int.MaxValue / sizeof(Int64) + 1
            };
        ...
        public void SimpleBinaryReader_ReadLength_NegativeLength_Throws()
        {
            ...
            var output = new Cdrcs.IO.Safe.OutputBuffer(16);
