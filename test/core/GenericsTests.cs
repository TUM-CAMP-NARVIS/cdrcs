namespace UnitTest
{
    ...
    public class GenericsTests
    {
        ...
        [Test]
        public void GenericsCdrcsed()
        {
            var obj = new GenericCdrcsed<Nested>();
            ...
            stream.Position = 0;
            obj = Util.DeserializeCB<GenericCdrcsed<Nested>>(stream);
        ...
        [Test]
        public void CdrcsedGeneric()
        {
            var obj = new CdrcsedGeneric();

            var field1 = Random.Init<Derived>();
            obj.cbt.nullableField = new Cdrcsed<Derived>(field1);

            var field2 = Random.Init<GenericDerived<string>>();
            obj.cbgws.field = new Cdrcsed<GenericClass<string>>(field2);

            var stream = new MemoryStream();
            
            Util.SerializeCB(obj, stream);
            stream.Position = 0;
            obj = Util.DeserializeCB<CdrcsedGeneric>(stream);
