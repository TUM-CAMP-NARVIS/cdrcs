...
namespace Cdrcs.Expressions
{
    ...
    /// <param name="valueType">Expression of type CdrcsDataType indicating the element type</param>
    ...
    /// <param name="keyType">Expression of type CdrcsDataType indicating the key type</param>
    /// <param name="valueType">Expression of type CdrcsDataType indicating the value type</param>
    ...
    public interface IField
    {
        ...
        /// <param name="valueType">Expression of type CdrcsDataType indicating the field type</param>
    ...
    /// <summary>
    /// Interface implemented by transforms to process Cdrcs schema instances
    /// </summary>
    public interface ITransform
    {
        ...
        /// <param name="fieldType">Expression of type CdrcsDataType representing the field type</param>
    ...
    /// <summary>
    /// Interface allowing parsing of different representations of Cdrcs schema instances, 
    /// such as serialized payloads or objects.
    /// </summary>
    public interface IParser
    {
        /// <summary>
        /// Apply transform to Cdrcs schema instance represented by the parser
        /// </summary>
        ...
        Expression Container(CdrcsDataType? expectedType, ContainerHandler handler);
        ...
        Expression Map(CdrcsDataType? expectedKeyType, CdrcsDataType? expectedValueType, MapHandler handler);
        ...
        /// </summary>
        /// <param name="valueType">Expression of type CdrcsDataType indicating the parser value type</param>
        ...
        Expression Scalar(Expression valueType, CdrcsDataType expectedType, ValueHandler handler);

        /// <summary>
        /// Get the value as an instance of <see cref="ICdrcsed"/>, can be called for value of type BT_STRUCT 
        /// and must be called to get value if <see cref="IsCdrcsed"/> returns true
        /// </summary>
        /// <param name="handler">Handler processing the ICdrcsed instance</param>
        /// <returns>Expression to process the ICdrcsed value</returns>
        Expression Cdrcsed(ValueHandler handler);

        /// <summary>
        /// Skip a value of specified type
        /// </summary>
        /// <param name="valueType">Expression of type CdrcsDataType indicating the type to skip</param>
        ...
        /// <summary>
        /// Indicates whether the value represented by the parser must be handled as ICdrcsed
        /// </summary>
        bool IsCdrcsed { get; }
    }
}
