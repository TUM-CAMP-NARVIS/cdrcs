...
namespace Cdrcs.Expressions.Pull
{
    ...
    public abstract class PullParser<T> : IParser
    {
        ...
        public abstract Expression Container(CdrcsDataType? expectedType, ContainerHandler handler);

        public abstract Expression Map(CdrcsDataType? expectedKeyType, CdrcsDataType? expectedValueType, MapHandler handler);

        public abstract Expression Blob(Expression count);

        public abstract Expression Scalar(Expression valueType, CdrcsDataType expectedType, ValueHandler handler);

        public virtual Expression Cdrcsed(ValueHandler handler)
        {
