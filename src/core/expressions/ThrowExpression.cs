...
namespace Cdrcs.Expressions
{
    ...
    {
        static readonly Expression<Action<CdrcsDataType>> throwInvalidTypeException = 
            t => ThrowInvalidTypeException(t);
        static readonly Expression<Action<CdrcsDataType, CdrcsDataType>> throwInvalidTypeException2 = 
        ...
        static void ThrowInvalidTypeException(CdrcsDataType actualType)
        {
            throw new InvalidDataException(string.Format("Invalid type {0}", actualType));
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        static void ThrowInvalidTypeException(CdrcsDataType expectedType, CdrcsDataType actualType)
        {
