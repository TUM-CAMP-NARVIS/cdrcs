...
namespace Cdrcs
{
    ...
    public static class Serialize
    {
        ...
        /// <summary>
        /// Serialize <see cref="ICdrcsed{T}" /> to protocol writer of type <typeparamref name="W"/>
        /// </summary>
        /// <typeparam name="W">Protocol writer</typeparam>
        /// <typeparam name="T">Type representing a Cdrcs schema</typeparam>
        /// <param name="writer">Writer instance</param>
        /// <param name="bonded"><see cref="ICdrcsed"/> instance</param>
        public static void To<W, T>(W writer, ICdrcsed<T> bonded)
        {
            bonded.Serialize(writer);
        }

        /// <summary>
        /// Serialize <see cref="ICdrcsed"/> to protocol writer of type <typeparamref name="W"/>
        /// </summary>
        /// <typeparam name="W">Protocol writer</typeparam>
        /// <param name="writer">Writer instance</param>
        /// <param name="bonded"><see cref="ICdrcsed"/> instance</param>
        public static void To<W>(W writer, ICdrcsed bonded)
        {
            bonded.Serialize(writer);
        }
    }
