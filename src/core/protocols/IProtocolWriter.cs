...
namespace Cdrcs.Protocols
{
    ...
    public interface IProtocolWriter
    {
        ...
        void WriteFieldBegin(CdrcsDataType type, ushort id, Metadata metadata);
        ...
        /// <param name="id">Identifier of the field</param>
        /// <param name="metadata">Metadata of the field</param>
        void WriteFieldOmitted(CdrcsDataType type, ushort id, Metadata metadata);
        ...
        void WriteContainerBegin(int count, CdrcsDataType elementType);
        ...
        /// <param name="count">Number of elements in the container</param>
        /// <param name="elementType">Type of the elements</param>
        void WriteFixedContainerBegin(int count, CdrcsDataType elementType);
        ...
        void WriteContainerBegin(int count, CdrcsDataType keyType, CdrcsDataType valueType);
        ...
        /// <summary>
        /// Write fixed size array of bytes verbatim
        /// </summary>
        void WriteByteArray(ArraySegment<byte> data);
